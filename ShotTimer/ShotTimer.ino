...
#define BUTTON_NONE 0x00 //!< No button
...
//////////////////////////////
// http://stackoverflow.com/questions/18903528/permanently-changing-value-of-parameter
uint8_t g_buttons_state = BUTTON_NONE;
...
// the I2C bus.
LiquidCrystal g_lcd(8, 13, 4, 5, 6, 7);
...
//////////////////////////////
void ButtonListener(LiquidCrystal* g_lcd, 
  ...
  *b_state = state_now;
  DEBUG_PRINT(F("new_button: ")); DEBUG_PRINTLN(new_button, 0);
  ///////////////
